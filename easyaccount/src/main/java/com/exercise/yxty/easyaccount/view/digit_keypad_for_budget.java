 ...
 */
public class digit_keypad_for_budget extends LinearLayout implements View.OnClickListener {

    OnKeyPadClickListener listener;
    public TextView display,tvEquals;

    public digit_keypad_for_budget(Context context) {
        super(context);
        initial();
    }


    public digit_keypad_for_budget(Context context, AttributeSet attrs) {
        super(context, attrs);
        initial();
    }

    private void initial() {
        View.inflate(getContext(), R.layout.view_decimal_for_budget, this);
        ...
        tvEquals = (TextView) findViewById(R.id.op_equals);
    ...
    public void setTvEqualsBackground(int resId) {
        tvEquals.setBackgroundResource(resId);
    }

    public void setTvEqualsText(String text) {
        tvEquals.setText(text);
    }
}
